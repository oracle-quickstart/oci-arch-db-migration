...
For details of the architecture, see [_Migrate an on-premises Oracle Database deployment to an autonomous database_](https://docs.oracle.com/en/solutions/migrate-to-atp/index.html)
...
1. Click [![Deploy to Oracle Cloud](https://oci-resourcemanager-plugin.plugins.oci.oraclecloud.com/latest/deploy-to-oracle-cloud.svg)](https://cloud.oracle.com/resourcemanager/stacks/create?region=home&zipUrl=https://github.com/oracle-quickstart/releases/latest/download/oci-arch-ee-atp-db-mig-stack-latest.zip)
...
Now, you'll want a local copy of this repo. You can make that with the commands:
    ...
    cd oci-arch-db-migration/oci-arch-ee-atp-db-mig
    ls
...
![](./images/oci-arch-ee-atp-db-mig.png)