...
For details of the architecture, see [_Migrate an on-premises Oracle Database deployment to a virtual machine DB system_](https://docs.oracle.com/en/solutions/migrate-to-vmdb/index.html)
...
Now, you'll want a local copy of this repo. You can make that with the commands:
    ...
    cd oci-arch-db-migration/oci-arch-se-vm-db-mig
    ls
...
![](./images/oci-arch-ee-vm-db-mig.png)